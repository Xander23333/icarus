...
| N4 | [Pearl 的因果阶梯与 LLM 的天花板](N4-pearl-ladder-and-llm-ceiling.md) | 🔨 推进中（§1–§5 / 估计 4500字） |
| N5 | [Embodiment 真的不可 tokenize 吗——VLA 路线的隐含赌注](N5-embodiment-and-vla-bet.md) | 🔨 推进中（§1–§4 / 估计 5500字） |
| N6 | [World model = 视频生成？三个团队的三种答案](N6-world-model-three-answers.md) | 🔨 推进中（§1–§4 / 估计 4500字） |
