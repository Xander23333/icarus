...
*本章正文约 4600 字。Searle / Harnad / Marcus / Sutton / Bubeck / Anthropic faithfulness / Apple illusion-of-thinking / Allen AI faith-and-fate / Reversal Curse 均给一手 source。GPT-4.5 训练成本数字标注 [uncertain]。下一章 N2 将进入第一类候选的精细化分析：formal expressivity bounds —— TC⁰ 上界、log-precision Transformer、固定深度下的不可解问题类。*
